...
public class BaseTest {
    ...
    protected static final String[] JOGADORES = {"kusmin", "hikaru", "vanius", "reader777"};
    protected static final String[] JOGADORES_GM = new String[]{
            "123lt",
            "124chess",
            "1977ivan",
            "1stsecond",
    ...
    @Autowired
    protected JogadorRepository jogadorRepository;
    @Autowired
    ...
    public Autorizacao criarUsuarioAuth(String email, String senha, Personas persona, String cpf, BigDecimal saldo) {
        ...
        return this.autenticar(usuario.getEmail(), senha);
    }
    ...
    protected Date alterarEdicao(Date dataUltimaAtualizacao) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(dataUltimaAtualizacao);
        calendar.set(Calendar.SECOND, (calendar.get(Calendar.SECOND) - (prazoAtualizar + 5)));
        return calendar.getTime();
    }
}
